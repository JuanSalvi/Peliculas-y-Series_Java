...
public class Mostrar_Series_Disponibles extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Mostrar_Series_Disponibles frame = new Mostrar_Series_Disponibles();
	 ...
	 * Create the frame.
	 */
	public Mostrar_Series_Disponibles() {
		...
		setTitle("Mostrar Series Disponibles");
		...
		scrollPane.setBounds(10, 37, 414, 180);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {//<----------- BOTON DE REGRESO A MENU ---------->
			 ...
			 Mostrar_Series_Disponibles.this.setVisible(false); //Se Deshabilita Venta Actual
			}
		});
