...
public class Mostrar_Peliculas_Disponibles_ extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Mostrar_Peliculas_Disponibles_ frame = new Mostrar_Peliculas_Disponibles_();
	 ...
	 * Create the frame.
	 */
	public Mostrar_Peliculas_Disponibles_() {
		...
		button.setBounds(167, 227, 89, 23);
