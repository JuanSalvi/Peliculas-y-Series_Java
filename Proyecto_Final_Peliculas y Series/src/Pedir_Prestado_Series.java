...
public class Pedir_Prestado_Series extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pedir_Prestado_Series frame = new Pedir_Prestado_Series();
	...
	public Pedir_Prestado_Series() {
		...
		scrollPane.setBounds(10, 39, 414, 175);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {//<----------- BOTON DE REGRESO A MENU ---------->
			Interfaz Regresar = new Interfaz();//Creacion de Objeto Conector a Interfaz Principal
			 ...
			 Pedir_Prestado_Series.this.setVisible(false); //Se Deshabilita Venta Actual
			}
		});
		button.setBounds(164, 225, 89, 23);
